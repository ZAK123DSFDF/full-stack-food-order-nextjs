...
var getSingleRole = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var token, ability, _a, restaurantId, restaurantExists, idInt, role, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 7:
                ...
                return [4 /*yield*/, prisma_1.prisma.servantRole.findFirst({
                        where: {
                            id: idInt,
