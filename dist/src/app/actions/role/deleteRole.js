...
var deleteRole = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var token, ability, _a, restaurantId, restaurantExists, idInt, existingRole, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, (0, checkAbilities_1.checkAbilities)(ability, enum_1.AllowedActions.DELETE_ROLE, Role_1.Role)];
            case 5:
                _a = (_b.sent());
                _b.label = 6;
            case 6:
            ...
            case 8:
                ...
                return [4 /*yield*/, prisma_1.prisma.servantRole.delete({
                        where: { id: idInt },
                    })];
            case 9:
                _b.sent();
                return [2 /*return*/, { message: "Servant role with ID ".concat(idInt, " has been deleted.") }];
