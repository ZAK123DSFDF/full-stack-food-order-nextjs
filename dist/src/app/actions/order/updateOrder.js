...
var updateOrder = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var token, ability, _c, restaurantId, restaurantExists, idInt, OrderStatusSchema, parsed, order, updatedOrder, error_1;
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, (0, checkAbilities_1.checkAbilities)(ability, enum_1.AllowedActions.UPDATE_ORDERS, Orders_1.Orders)];
            case 5:
                _c = (_d.sent());
                _d.label = 6;
            case 6:
            ...
            case 7:
                ...
                OrderStatusSchema = zod_1.z.enum(["PREPARING", "READY", "DELIVERED"]);
                parsed = OrderStatusSchema.safeParse(status);
                if (!parsed.success) {
            ...
            case 8:
                order = _d.sent();
                if (restaurantId !== (order === null || order === void 0 ? void 0 : order.menu.restaurantId)) {
