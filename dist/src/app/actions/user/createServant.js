...
var createServant = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var token, ability, _c, restaurantId, restaurantExists, servantRoleIdInt, SignupSchema, parsed, existUser, existingServantRole, hashedPassword, user, error_1;
    var name = _b.name, email = _b.email, password = _b.password, phoneNumber = _b.phoneNumber, location = _b.location, servantRoleId = _b.servantRoleId;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, (0, checkAbilities_1.checkAbilities)(ability, enum_1.AllowedActions.ADD_USER, Users_1.Users)];
            case 5:
                _c = (_d.sent());
                _d.label = 6;
            case 6:
            ...
            case 7:
                ...
                servantRoleIdInt = parseInt(servantRoleId, 10);
            ...
            case 9:
                ...
                _d.label = 10;
            case 10: return [4 /*yield*/, bcrypt.hash(password, 10)];
            case 11:
            ...
            case 13: throw new Error("you are not authorize to do this action");
...
exports.createServant = createServant;
