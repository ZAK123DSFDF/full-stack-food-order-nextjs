...
var getAllServants = function (globalSearch, name, phoneNumber, email, location, active, sortBy, sortOrder) { return __awaiter(void 0, void 0, void 0, function () {
    var token, ability, _a, restaurantId, restaurantExists, whereCondition, orderBy, servants, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, (0, checkAbilities_1.checkAbilities)(ability, enum_1.AllowedActions.GET_USERS, Users_1.Users)];
            case 5:
                _a = (_b.sent());
                _b.label = 6;
            case 6:
...
exports.getAllServants = getAllServants;
