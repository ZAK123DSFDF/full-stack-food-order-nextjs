...
exports.deactivateServant = void 0;
...
var deactivateServant = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var token, ability, _a, restaurantId, restaurantExists, idInt, user, updatedUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, (0, checkAbilities_1.checkAbilities)(ability, enum_1.AllowedActions.UPDATE_USER, Users_1.Users)];
            case 5:
                _a = (_b.sent());
                _b.label = 6;
            case 6:
            ...
            case 8:
                user = _b.sent();
                if (restaurantId !== (user === null || user === void 0 ? void 0 : user.restaurantId)) {
...
exports.deactivateServant = deactivateServant;
